...
class Zf2EventStoreAdapter implements AdapterInterface, TransactionFeatureInterface
{
    ...
    public function createSchema(array $streams)
    {
        ...
        sprintf(
            'The createSchema command is not supported for %s. Please create the schema of your own or try doctine/dbal adapter instead.', $this->dbAdatper->getPlatform()->getName()
        )
        );
    }
    ...
    public function dropSchema(array $streams)
    {
        ...
        throw new \BadMethodCallException(
        sprintf(
            'The dropSchema command is not supported for %s. Please create the schema of your own or try doctine/dbal adapter instead.', $this->dbAdatper->getPlatform()->getName()
        )
        );
    }
    ...
    public function exportSchema($file, $snapshots_only)
    {
        throw new \BadMethodCallException(
        sprintf(
            'The exportSchema command is not supported for %s. Please create the schema of your own or try doctine/dbal adapter instead.', $this->dbAdatper->getPlatform()->getName()
        )
        );
    }
    ...
    public function importSchema($file)
    {
        throw new \BadMethodCallException(
        sprintf(
            'The importSchema command is not supported for %s. Please create the schema of your own or try doctine/dbal adapter instead.', $this->dbAdatper->getPlatform()->getName()
        )
        );
    }
